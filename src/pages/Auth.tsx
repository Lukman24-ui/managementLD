...
        if (error) {
          // ✅ PERBAIKAN: Gunakan pesan error Supabase yang lebih spesifik
...
          toast.error(errorMessage);
        } else {
          // ✅ PERBAIKAN UX: Kosongkan field setelah sign up berhasil
...
      }
    } catch (error: any) {
      // Catch-all for unexpected errors (e.g., network failure, server down)
...
              type="button" // ✅ Ditambahkan: Pastikan tombol ini tidak melakukan submit
            >
